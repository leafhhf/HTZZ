...
cursor.execute('delete from industry_develop_index where index_num ="2_5"')
...
select year,name,value,original_self_value,original_max_value,index_id,index_num,index_name,sequence,type,field from industry_develop_index_ue where index_num ='2_5'
'''
cursor.execute(sql)
