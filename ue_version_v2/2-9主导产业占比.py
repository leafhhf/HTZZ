...
for field in field_list:
    sql_cmd = '''select * from ai_zhudao_chanye'''
    ...
    if len(df_SQL) > 0:
        ...
        df_SQL["num"] =  df_SQL["num"].astype("float")
...
cursor.execute('delete from industry_develop_index where index_num ="2_9"')
...
sql = '''
    ...
    select year,name,value,original_self_value,original_max_value,index_id,index_num,index_name,sequence,type,field from industry_develop_index_ue where index_num ='2_9'
    '''
cursor.execute(sql)
