...
class AiIndustryReportsPipeline(object):
...
#       self.conn = pymysql.connect(host="172.16.16.152", user="root", passwd="123456", db="knowledge_graph", charset='utf8')
    ...
    def process_item(self, item, spider):
        ...
        params = [item['title'], item['orgName'], item['orgSName'],item['publishDate'],item['industryName'], item['researcher'],item['url'],item['orgName'],item['pdfurl']]
        print('params',params)
