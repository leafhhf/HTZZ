...
import pymysql
from lianmenhu.mysql_config import insert_db
from lianmenhu.mysql_config import select_db
import pymysql
class LianmenhuPipeline(object):
    def __init__(self):
        # 连接数据库
    ...
    def process_item(self, item, spider):
        ...
        db_table = 'lianmenhu_news_information'
