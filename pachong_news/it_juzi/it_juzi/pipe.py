    ...
    def process_item(self, item, spider):
        ...
        try:
            com = self.cur.execute(
                'insert into itjuzi_tourongzi(com_name, com_registered_name, com_des, com_scope, prov, city, round, money, invse_company, invse_des, invse_time, invse_title)values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',params)
            self.conn.commit()
        except Exception as e:
