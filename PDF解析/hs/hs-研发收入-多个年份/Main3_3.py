...
from hs2_parsing_yftr5_2 import write_to_dict_6_2, match_yftr2
...
# 3.创建集合
mycol = db["hushen_yanfatouru_bc3"]
       ...
       # print('files',files)
        for index, filename in enumerate(files):
           # print('filename',filename)
            ...
            f = open('result/filename3.csv','a',newline='')
            ff= open('result/filename3.csv','r',newline='')
            #encoding='gbk',
            writer=csv.writer(f)
            ...
            try:
                        ...
                        f1 = open('result/no_yftr3.csv', 'a', newline='')
                        f2 = open('result/no_yftr3.csv', 'r', newline='')
