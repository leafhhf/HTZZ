...
cursor.execute('delete from industry_develop_index_global where index_num ="3_2"')
...
sql = '''
        ...
        select year,name,value,original_self_value,original_max_value,index_id,index_num,index_name,sequence,type,field from industry_develop_index_global_test where index_num ='3_2'
        '''
cursor.execute(sql)
