...
for field in field_list:
    #第一步 先读取各个省份企业的雇工人数
    sql_cmd1 ='''select found_year, social_security_staff_num as com_pop,province  from kjb_dc_company where label like '%{}%' 
    ...
    if len(df_SQL) > 0:
        ...
        df_final=df_all[["name","original_self_value","year","original_max_value","index_name","index_num","index_id","type","field","sequence","value","level"]]
