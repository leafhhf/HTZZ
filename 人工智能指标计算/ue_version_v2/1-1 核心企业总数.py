...
for field in field_list:
    ...
    # 省份处理
        ...
        df_all=pd.DataFrame()
        df_pivot = pd.pivot_table(df_SQL, index="found_year", columns="new_province",values="num")
...
cursor.execute('delete from industry_develop_index where index_num ="1_1"')
...
select year,name,value,original_self_value,original_max_value,index_id,index_num,index_name,sequence,type,field from industry_develop_index_ue where index_num ='1_1'
'''
cursor.execute(sql)
