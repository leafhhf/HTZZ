...
import os
import time
## https://blog.csdn.net/zhusongziye/article/details/83933552
# 比Selenium快100倍的方法爬东方财富网财务报表
# 设置文件保存在D盘eastmoney文件夹下
file_path = 'E:\python+download'
...
def set_table():
    ...
    if tables == 1:
        ...
        st = 'ndate'
        sr = -1
        filter = " (IsLatest='T')(enddate=^2019-12-31^)"
    elif tables == 4:
        category_type = 'YJBB20_'
        st = 'frdate'
        sr = 1
...
def write_header(data, category):
    with open('{}.csv'.format(category), 'a', encoding='utf_8', newline='') as f:
