...
from chinagov.mysql_config import insert_db
from chinagov.mysql_config import select_db
import pymysql


class ChinagovPipeline(object):
    def __init__(self):
        # 连接数据库
    ...
    def process_item(self, item, spider):
        ...
        db_table = 'rm_policy_publication_crawl'
