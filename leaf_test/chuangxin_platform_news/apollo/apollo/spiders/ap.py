# -*- coding: utf-8 -*-
import scrapy
from apollo.items import ApolloItem
import datetime
import  time
...
class ApSpider(scrapy.Spider):
    name = 'ap'
    # allowed_domains = ['https://www.chinaz.com/tags/Apollo.shtml']
    start_urls = ['https://www.chinaz.com/tags/Apollo.shtml']
    ...
    headers = {
        ...
        'Referer': 'https://www.baidu.com/link?url=xHYO8WII6UzN8omYhSgFxdS1I-g6hXw6rrNFAE2D2_8e0ZsVCyirhFgchmXJ-zNmstxqFg7HOtb-6m3sws3O4K&wd=&eqid=b9e191d50000c2140000000260e2add7',
