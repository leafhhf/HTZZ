...
from haoweilai.mysql_config import insert_db
from haoweilai.mysql_config import select_db
import pymysql



class HaoweilaiPipeline:
    def __init__(self):
        # 连接数据库
    ...
    def process_item(self, item, spider):
        ...
        db_table = 'ai_chuangxin_platform_news_haoweilai'
