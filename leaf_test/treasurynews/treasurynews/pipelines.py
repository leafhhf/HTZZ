...
class TreasurynewsPipeline:
    def process_item(self, item, spider):
        return item

import pymysql
from treasurynews.mysql_config import insert_db
from treasurynews.mysql_config import select_db
import pymysql
class TreasurynewsPipeline(object):
    def __init__(self):
        # 连接数据库
    ...
    def process_item(self, item, spider):
        ...
        db_table = 'block_lawsuit_incident_treasury_pr'
