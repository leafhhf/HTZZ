...
from jishufengsuo.mysql_config import insert_db
from jishufengsuo.mysql_config import select_db
import pymysql




class JishufengsuoPipeline(object):
    def __init__(self):
        # 连接数据库
    ...
    def process_item(self, item, spider):
        ...
        db_table = 'block_lawsuit_incident'
